                    ...
                    data.data.map(movie => {
                      return (
                        <tr>
                              ...
                              <div className="flex-shrink-0 w-10 h-10">
                                {
                                  movie.url ?
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         ...
                                         viewBox="0 0 24 24" stroke-width="1.5" stroke="#cbd5e0" fill="none"
                                         stroke-linecap="round" stroke-linejoin="round">
                                      <path stroke="none" d="M0 0h24v24H0z"/>
                          ...
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p className="text-gray-900 whitespace-no-wrap" style={{textAlign: 'center'}}>{movie.author}</p>
                          </td>
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p className="text-gray-900 whitespace-no-wrap" style={{textAlign: 'center'}}>
                              {moment(movie.date).format('MMM[, ]DD YYYY')}
                            </p>
                          </td>
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm" style={{textAlign: 'center'}}>
                          ...
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <svg
                              ...
                              onClick={async () => await removeMovie(movie.id) ? alert('Movie removed successfully ') : alert('Error removing movie') }
                              height="10pt" viewBox="0 0 365.71733 365" width="10pt"><g fill="#f44336"><path d="m356.339844 296.347656-286.613282-286.613281c-12.5-12.5-32.765624-12.5-45.246093 0l-15.105469 15.082031c-12.5 12.503906-12.5 32.769532 0 45.25l286.613281 286.613282c12.503907 12.5 32.769531 12.5 45.25 0l15.082031-15.082032c12.523438-12.480468 12.523438-32.75.019532-45.25zm0 0"/><path d="m295.988281 9.734375-286.613281 286.613281c-12.5 12.5-12.5 32.769532 0 45.25l15.082031 15.082032c12.503907 12.5 32.769531 12.5 45.25 0l286.632813-286.59375c12.503906-12.5 12.503906-32.765626 0-45.246094l-15.082032-15.082032c-12.5-12.523437-32.765624-12.523437-45.269531-.023437zm0 0"/></g></svg>
                          </td>
                        </tr>
                  )})
                  }
